<template>
  <div>
    ...
    <div class="login_form">
      <input type="text"  class="qxs-ic_user qxs-icon"  placeholder="Email" v-model="email">
      ...
      <div style="margin-top: 10px">
        <b-nav-item to ="/login"><span style="float: left;color: #000099;" @click="login">Login with Username</span></b-nav-item><span style="float: right;color: #A9A9AB">Forget Password</span>
      </div>
    </div>
  </div>
</template>
