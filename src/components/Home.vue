<template>
  <div class="hero">
    ...
    <br>
    <div>
      <img src="../assets/homebg.jpg" height="" width=100% style="">
      <h1 class="vue-title">Welcome to Attraction Management System</h1>
    </div>
    <table align="center">
      <tr>
        <td style="position: relative; left: 5%;top: 30%;">
          <img src="../assets/homer.gif" alt="description here" />
        </td>
        <td>
        <div id="slider" style="position: relative; left:-27%; top: 8px;">
...
<style>
  ...
  h1{font-size:16px;color: rgba(255, 255, 255, 0.99);position:absolute;top:20px;left:10px;}
</style>
<script>
export default {
  name: 'slider',
